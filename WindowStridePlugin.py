...
def main(data_path,data_covariates_path,date_column,cast_float16,window_size,stride_size,test_ratio,save_name):
	...
	save_path = PyPluMA.prefix()
	save_name = save_name.replace(save_path, '')
...
class WindowStridePlugin:
	...
	# Extracting arguments :
        ...
        self.cast_float16 = False

        self.window_size = int(self.parameters["windowsize"])
        self.stride_size = int(self.parameters["stridesize"])
        self.test_ratio = float(self.parameters["testratio"])
    ...
    def output(self, filename):
        main(self.data_path,self.data_covariates_path,self.date_column,self.cast_float16,self.window_size,self.stride_size,self.test_ratio,filename)
